...
locals {
  ...
  requested_version  = local.version_count > 0 ? local.supported_versions[local.version_count - 1] : data.azurerm_kubernetes_service_versions.current.latest_version
}
